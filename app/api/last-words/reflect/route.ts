...
const FALLBACK_REFLECTIONS = [
  'There is something deeply human in choosing those particular words when all others fade away.',
  'The things we hold onto at the end reveal what mattered most from the very beginning.',
  'In those few words lives an entire philosophy of what it means to be alive.',
]
...
Offer a brief, warm reflection (2-3 sentences) on the beauty or meaning in their words. Don't quote them back. Don't moralize or judge. Don't use phrases like "It's clear that" or "This shows that." Just reflect with genuine warmth and philosophical depth, as a wise friend might. Speak directly and gently.
...
Return ONLY the reflection text, no quotes, no labels, no formatting.`
    ...
    console.error('Last words reflect error:', error)
